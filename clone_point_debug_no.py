...
async def process_voice_clone(request: Request):
    ...
    try:
        ...
        try:
            ...
            with tempfile.NamedTemporaryFile(delete=False, suffix=".wav") as untrusted_file:
                ...
                while True:
                    ...
                    if len(header) < 12:
                        ...
                        # RIFF/WAVE header validation disabled as requested.
            ...
            # RIFF/WAVE container validation disabled as requested.
...
if __name__ == "__main__":
    ...
    uvicorn.run("clone_point_debug_no:app", host="0.0.0.0", port=8000, reload=False)